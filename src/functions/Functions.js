...
export const removeCommessa = (index, selectedCommesse, setSelectedCommesse) => {
    ...
    export const saveEvent = async (eventData, projectResources, fetchEvents) => {
      ...
      try {
          const response = await fetch('https://localhost:3004/api/eventi', {
              method: 'POST',
    ...
    export const deleteEvent = async (eventId,fetchEvents) => {
        try {
          const response = await fetch(`https://localhost:3004/api/eventi/${eventId}`, {
            method: 'DELETE'
          });
          const data = await response.json();
   ...
   export const saveSelectedCommesse = async (
    ...
    try {
      ...
      const response = await fetch(
        `https://localhost:3004/api/collaboratori/${collaboratoreId}`,
        {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
  ...
  export const updateEvent = async (eventData, fetchEvents) => {
    ...
    try {
      const response = await fetch(`https://localhost:3004/api/eventi/${eventData.Id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          ...eventData,
...
export const fetchProjectResources = async () => {
  try {
    const response = await fetch('https://localhost:3004/api/commesse');
    const data = await response.json();
