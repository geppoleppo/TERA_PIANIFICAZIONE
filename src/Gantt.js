...
<GanttComponent
  ...
  taskFields={{
    ...
    endDate: 'EndTime',
    progress: 'Progress',
    // Aggiungi i campi per commessa e incaricato
...
>
  ...
  <ColumnsDirective>
    ...
    <ColumnDirective field="CommessaName" headerText="Commessa" width="150"/>  // Colonna per il nome della commessa
    <ColumnDirective field="IncaricatoId" headerText="Incaricato ID" width="150"/>  // Colonna per l'ID dell'incaricato
